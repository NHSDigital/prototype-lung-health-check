...
flowchart TD
  ...
  classDef data fill:#d9f3f0,stroke:#00a499,color:#212b32,stroke-width:2px
  linkStyle default stroke:#4c6272,stroke-width:2px
  class changedDecision,cya,fewerSelected,formerSmokerDecision,isShisha,moreTypes,nextType controlFlow
  class changed,fewerChange,moreChange,selectedType,status,tobaccoSmoking process
```
